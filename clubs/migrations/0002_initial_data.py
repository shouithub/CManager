...
def populate_requirements(apps, schema_editor):
    ...
    requirements = [
        ...
        # 2. Club Registration (club_registration)
        {
        ...
        # 3. Club Application (club_application)
        {
        ...
        # 5. President Transition (president_transition)
        {
        ...
        # 7. Activity Application (activity_application)
        {
...
def reverse_func(apps, schema_editor):
    # We generally don't delete data on reverse for this kind of init script
    # but to be strict:
    pass
