# Merged migration: combines 0001_initial + 0002_initial_data + 0003_remove_club_president
#                   + 0004_site_settings_daily_stat into a single initial migration.
...
# ---------------------------------------------------------------------------
# Data population functions (originally from 0002_initial_data)
# ---------------------------------------------------------------------------
...
def populate_requirements(apps, schema_editor):
    ...
    requirements = [
        ...
        {'request_type': 'club_application',   'name': '社团拟任负责人和指导老师的详细简历和身份证复印件',        'is_required': True,  'legacy_field_name': 'leaders_resumes',            'order': 40, 'allowed_extensions': '.zip,.rar,.docx'},
        {'request_type': 'club_application',   'name': '社团组建一个月后的活动计划',                           'is_required': True,  'legacy_field_name': 'one_month_activity_plan',    'order': 50},
        {'request_type': 'club_application',   'name': '社团老师的相关专业证书',                              'is_required': True,  'legacy_field_name': 'advisor_certificates',       'order': 60, 'allowed_extensions': '.zip,.rar,.jpg,.png'},
        {'request_type': 'president_transition','name': '社团主要负责人变动申请表',                            'is_required': True,  'legacy_field_name': 'transition_form',            'order': 10, 'allowed_extensions': '.docx,.pdf'},
        {'request_type': 'reimbursement',      'name': '报销凭证',                                           'is_required': True,  'legacy_field_name': 'receipt_file',               'order': 10},
        {'request_type': 'activity_application','name': '活动申请表',                                        'is_required': True,  'legacy_field_name': 'application_form',           'order': 10, 'allowed_extensions': '.docx,.pdf'},
    ]
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # --- 以下来自 0004_site_settings_daily_stat ---
        migrations.CreateModel(
            name='DailyStat',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body_font_family', models.CharField(blank=True, default='', help_text="CSS font-family 値，例如：'Noto Sans SC', sans-serif（留空则使用系统字体）", max_length=300, verbose_name='正文字体族')),
            ],
            options={
                'verbose_name': '站点设置',
