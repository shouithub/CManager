...
# clubs.migrations.0001_squashed_0013_formchannel_show_zip_download
# clubs.migrations.0014_storageconfig
# clubs.migrations.0021_encrypt_service_credentials
# clubs.migrations.0031_formchannel_alert_settings
# clubs.migrations.0033_remove_registrationtoken_rt_club_exp_used_idx_and_more
# clubs.migrations.0035_template

def safe_filename_part(value):
    """把标签转换为安全的文件名字段，去除路径分隔符与非法字符。"""
    text = re.sub(r'[\\/:*?"<>|\r\n\t]+', '_', str(value or '')).strip(' ._')
    return text or '附件'


def move_file(storage, old_name, target):
    """在同一存储内把文件移动到新路径（自动处理重名），并删除旧文件。"""
    with storage.open(old_name, 'rb') as source:
        content = source.read()
    new_name = storage.save(target, ContentFile(content))
...
class Migration(migrations.Migration):
    ...
    replaces = [('clubs', '0001_init'), ('clubs', '0001_squashed_0013_formchannel_show_zip_download'), ('clubs', '0014_storageconfig'), ('clubs', '0015_announcement_link_url'), ('clubs', '0016_formchannel_publish_status'), ('clubs', '0017_formchannel_cycle_type_labels'), ('clubs', '0018_avatar_service'), ('clubs', '0019_user_avatar_choice'), ('clubs', '0020_room_booking_integrity'), ('clubs', '0021_encrypt_service_credentials'), ('clubs', '0022_config_change_log'), ('clubs', '0023_explicit_unique_constraints'), ('clubs', '0024_formsubmission_dashboard_index'), ('clubs', '0025_sitesettings_third_party_cdn'), ('clubs', '0026_sitesettings_third_party_cdn_sri'), ('clubs', '0027_sitesettings_site_info'), ('clubs', '0028_sitesettings_homepage_subtitle'), ('clubs', '0029_formchannel_example_file'), ('clubs', '0030_channelexamplefile'), ('clubs', '0031_formchannel_alert_settings'), ('clubs', '0032_sitesettings_low_member_alert_threshold'), ('clubs', '0033_remove_registrationtoken_rt_club_exp_used_idx_and_more'), ('clubs', '0034_delete_template'), ('clubs', '0035_template')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('backend_type', models.CharField(choices=[('local', '本地存储'), ('s3', 'S3 兼容对象存储（AWS S3 / MinIO / 阿里云 OSS / 腾讯云 COS 等）')], default='local', help_text='选择文件存储位置。切换后立即生效，已存文件不会自动迁移。', max_length=20, verbose_name='后端类型')),
                ('is_active', models.BooleanField(default=True, help_text='关闭后强制降级到本地存储（紧急回退用）', verbose_name='是否启用')),
                ('s3_endpoint_url', models.CharField(blank=True, default='', help_text='AWS S3 留空；MinIO/阿里云/腾讯云等填兼容端点，如 https://s3.cn-north-1.amazonaws.com.cn', max_length=500, verbose_name='S3 Endpoint URL')),
                ('s3_region', models.CharField(blank=True, default='', help_text='AWS S3 必填，如 us-east-1；MinIO 可留空', max_length=100, verbose_name='Region')),
                ('s3_bucket_name', models.CharField(blank=True, default='', help_text='需提前在 S3 控制台创建；Office Online 预览要求 bucket 可公网匿名访问', max_length=255, verbose_name='Bucket 名称')),
                ('s3_access_key_id', models.CharField(blank=True, default='', max_length=255, verbose_name='AccessKey ID')),
                ('s3_secret_access_key', models.CharField(blank=True, default='', help_text='明文存储，请确保数据库访问严格受控', max_length=500, verbose_name='Secret Access Key')),
                ('s3_custom_domain', models.CharField(blank=True, default='', help_text='如已配置 CDN，填写 CDN 域名（如 https://cdn.example.com）。留空则使用 S3 默认 URL。', max_length=500, verbose_name='自定义域名 / CDN')),
                ('s3_addressing_style', models.CharField(choices=[('auto', '自动（推荐）'), ('path', 'Path Style（适用于 MinIO / 自建）'), ('virtual', 'Virtual Hosted Style（适用于 AWS S3）')], default='auto', help_text='MinIO / 自建 S3 通常选 Path Style；AWS S3 选 Virtual Hosted', max_length=20, verbose_name='地址风格')),
                ('s3_use_path_style', models.BooleanField(default=True, help_text='与 address_style 互补，兼容部分 MinIO 版本', verbose_name='强制 Path Style')),
                ('presigned_url_expiration', models.IntegerField(default=3600, help_text='私密 bucket 下载链接的有效时长，默认 1 小时', verbose_name='预签名 URL 有效期（秒）')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
            ],
            options={
        ...
        migrations.RunPython(
            code=migration_init_default_storage,
            reverse_code=migration_remove_default_storage,
        ),
        migrations.AddField(
        ...
        migrations.RunPython(
            code=encrypt_existing_credentials,
            reverse_code=django.db.migrations.operations.special.RunPython.noop,
        ),
        migrations.CreateModel(
        ...
        migrations.AddIndex(
            model_name='formsubmission',
            index=models.Index(fields=['submitter', 'club', 'channel', '-submitted_at'], name='fs_submit_club_chan_date'),
        ),
        migrations.AddField(
            model_name='sitesettings',
            name='third_party_cdn_base_url',
            field=models.CharField(default='https://cdn.bootcdn.net', help_text='用于加载 Chart.js、Swiper 和 Cropper.js 等 cdnjs 资源。', max_length=500, verbose_name='第三方资源 CDN 基础地址'),
        ),
        migrations.AddField(
            model_name='sitesettings',
            name='third_party_cdn_sri',
            field=models.JSONField(blank=True, default=dict, help_text='由管理页面在切换 CDN 时自动计算。', verbose_name='第三方资源 SRI 校验值'),
        ),
        migrations.AddField(
            model_name='sitesettings',
            name='homepage_title',
            field=models.CharField(default='社团管理服务中心', help_text='显示在首页顶部横幅中的大标题', max_length=120, verbose_name='首页主标题'),
        ),
        migrations.AddField(
            model_name='sitesettings',
            name='site_name',
            field=models.CharField(default='社团管理系统', help_text='显示在浏览器标签页标题中，修改后刷新页面生效', max_length=120, verbose_name='站点名称（浏览器标题）'),
        ),
        migrations.AddField(
            model_name='sitesettings',
            name='homepage_subtitle',
            field=models.CharField(default='致力于为社团提供全方位的管理与服务支持，促进社团健康发展', help_text='显示在首页顶部横幅中主标题下方', max_length=300, verbose_name='首页副标题'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='example_files', to='clubs.formchannel', verbose_name='通道')),
            ],
            options={
                'verbose_name': '通道示例文件',
        ...
        migrations.RunPython(
            code=enable_alert_for_builtin_channels,
            reverse_code=django.db.migrations.operations.special.RunPython.noop,
        ),
        migrations.AddField(
            model_name='sitesettings',
            name='low_member_alert_threshold',
            field=models.PositiveSmallIntegerField(default=20, help_text='成员数低于该值的社团会在干事社团管理页触发“社团成员数量预警”。', verbose_name='成员数量告警阈值'),
        ),
        migrations.RunPython(
            code=backfill_profile_data,
            reverse_code=django.db.migrations.operations.special.RunPython.noop,
        ),
        migrations.RemoveIndex(
            model_name='registrationtoken',
