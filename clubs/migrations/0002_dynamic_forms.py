...
DEFAULT_CHANNELS = [
    ...
    ('活动申请', 'activity-application', 'event', 'activity_application', 50, [
        ('activity_name', '活动名称', 'text', True, 10, {}, {'max_length': 200}),
        ('activity_type', '活动类型', 'select', True, 20, ['讲座', '比赛', '演出', '培训', '志愿服务', '其他'], {}),
        ('activity_date', '活动日期', 'date', True, 30, {}, {}),
        ('activity_time_start', '开始时间', 'time', True, 40, {}, {}),
        ('activity_time_end', '结束时间', 'time', True, 50, {}, {}),
        ('location', '活动地点', 'text', True, 60, {}, {'max_length': 200}),
        ('participant_count', '预计人数', 'number', True, 70, {}, {'min': 1}),
        ('is_public', '是否公开报名', 'radio', True, 80, ['是', '否'], {}),
        ('description', '活动说明', 'textarea', True, 90, {}, {}),
        ('application_file', '活动申请材料', 'file', False, 100, {}, {'allowed_extensions': ['.doc', '.docx', '.pdf', '.zip'], 'max_size_mb': 20}),
    ]),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('builtin_action', models.CharField(choices=[('none', '无'), ('annual_review', '社团年审'), ('club_registration', '社团注册'), ('club_application', '社团申请'), ('reimbursement', '报销申请'), ('activity_application', '活动申请'), ('president_transition', '社长换届')], default='none', max_length=50, verbose_name='内置动作')),
