...
urlpatterns = [
    ...
    path('activities/', views.public_activities, name='public_activities'),  # 公共活动页面
    path('activity/<int:activity_id>/join/', views.join_activity, name='join_activity'),  # 参加活动
    path('activities/my/', views.my_activities, name='my_activities'),  # 我的活动
    path('activity/<int:activity_id>/participants/', views.activity_participants, name='activity_participants'),  # 活动报名名单
    ...
    path('approval-center/', views.approval_center, name='approval_center'),  # 审批中心
    path('approval-center/<str:item_type>/', views.approval_history_by_type, name='approval_history_by_type'),  # 按类型显示审批历史
    path('approval-center/<str:item_type>/<int:item_id>/', views.approval_detail, name='approval_detail'),  # 审批详情
    ...
    path('zip-registration-docs/<int:registration_id>/', views.zip_registration_docs, name='zip_registration_docs'),
    ...
    path('staff/test-review-access/<int:registration_id>/', views.test_review_access, name='test_review_access'),
    ...
    path('staff/review-room222-booking/<int:booking_id>/', views.review_room222_booking, name='review_room222_booking'),
    
    # 教师功能
    path('teacher/dashboard/', views.teacher_dashboard, name='teacher_dashboard'),
    path('teacher/review-activity/<int:activity_id>/', views.teacher_review_activity, name='teacher_review_activity'),
    path('teacher/review-history/', views.teacher_review_history, name='teacher_review_history'),
    ...
    path('admin-panel/reset-user-password/<int:user_id>/', views.admin_reset_user_password, name='admin_reset_user_password'),
    path('admin-panel/change-user-role/<int:user_id>/', views.change_user_role, name='change_user_role'),
    path('admin-panel/create-teacher/', views.create_teacher_account, name='create_teacher'),
